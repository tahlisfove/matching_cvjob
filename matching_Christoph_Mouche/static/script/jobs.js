...
function updateSecondPartDropdown(selectedFirstElement, data) {
    ...
    secondPartDropdown.innerHTML = '<option value="" disabled selected hidden>Choose a job*</option>';
...
Papa.parse('https://raw.githubusercontent.com/tahlisfove/matching_cvjob/dataset/jobs_descriptions.csv', {
